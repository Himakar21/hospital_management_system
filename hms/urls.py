...
urlpatterns = [
    ...
    path('show_patients/<int:id>/',SpecificPatientView),
    path('show_patients/',AllPatientsView),
    path('add_patient/',AddPatientView),
    path('show_appointments/<int:id>/',SpecificAppointmentView),
    path('show_appointments/',AllAppointmentsView),
    path('add_appointment/',AddAppointmentView),
    path('update_status/<int:id>',UpdateStatusView),
